...
export interface IPDXPredictionMarketInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyNoWithPDXFor"
      | "buyYesWithPDXFor"
...
export interface IPDXPredictionMarket extends BaseContract {
  connect(runner?: ContractRunner | null): IPDXPredictionMarket;
  waitForDeployment(): Promise<this>;

  interface: IPDXPredictionMarketInterface;
