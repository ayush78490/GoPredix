...
export declare namespace IPDXPredictionMarket {
...
export declare namespace PDXPredictionMarket {
...
export interface PDXPredictionMarketInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buyNoWithPDXFor"
      | "buyYesWithPDXFor"
...
export interface PDXPredictionMarket extends BaseContract {
  connect(runner?: ContractRunner | null): PDXPredictionMarket;
  waitForDeployment(): Promise<this>;

  interface: PDXPredictionMarketInterface;
  ...
  getMarketInfo: TypedContractMethod<
    [id: BigNumberish],
    [IPDXPredictionMarket.MarketInfoStructOutput],
    "view"
  >;

  getOrderInfo: TypedContractMethod<
    [id: BigNumberish],
    [IPDXPredictionMarket.OrderInfoStructOutput],
    "view"
  >;

  getRecentTrades: TypedContractMethod<
    [marketId: BigNumberish, count: BigNumberish],
    [PDXPredictionMarket.TradeInfoStructOutput[]],
    "view"
  >;
  ...
  setFees: TypedContractMethod<
    [_feeBps: BigNumberish, _creatorFeeBps: BigNumberish],
    [void],
    "nonpayable"
  >;
