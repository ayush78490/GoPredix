...
export declare namespace BNBNativeMarketplace {
...
export interface BNBNativeMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOffer"
      | "accumulatedFees"
...
export namespace MarketBoughtEvent {
  export type InputTuple = [
    listingId: BigNumberish,
    marketId: BigNumberish,
    seller: AddressLike,
...
export interface BNBNativeMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): BNBNativeMarketplace;
  waitForDeployment(): Promise<this>;

  interface: BNBNativeMarketplaceInterface;
  ...
  getListing: TypedContractMethod<
    [listingId: BigNumberish],
    [BNBNativeMarketplace.MarketListingStructOutput],
    "view"
  >;
  ...
  getMarketOwner: TypedContractMethod<
    [marketId: BigNumberish],
    [string],
    "view"
  >;
  ...
  getOffer: TypedContractMethod<
    [marketId: BigNumberish, buyer: AddressLike],
    [BNBNativeMarketplace.OfferStructOutput],
    "view"
  >;
  ...
  makeOffer: TypedContractMethod<[marketId: BigNumberish], [void], "payable">;
  ...
  marketOwners: TypedContractMethod<[arg0: BigNumberish], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "getMarketOwner"
  ...
  getEvent(
    ...
    MarketBoughtEvent.InputTuple,
    MarketBoughtEvent.OutputTuple,
    MarketBoughtEvent.OutputObject
  >;
  getEvent(
    key: "MarketListed"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "MarketBought(uint256,uint256,address,address,uint256,uint256)": TypedContractEvent<
      MarketBoughtEvent.InputTuple,
      MarketBoughtEvent.OutputTuple,
      MarketBoughtEvent.OutputObject
    >;
    MarketBought: TypedContractEvent<
      MarketBoughtEvent.InputTuple,
      MarketBoughtEvent.OutputTuple,
      MarketBoughtEvent.OutputObject
    >;
    ...
    "MarketOwnershipTransferred(uint256,address,uint256)": TypedContractEvent<
      MarketOwnershipTransferredEvent.InputTuple,
      MarketOwnershipTransferredEvent.OutputTuple,
      MarketOwnershipTransferredEvent.OutputObject
    >;
