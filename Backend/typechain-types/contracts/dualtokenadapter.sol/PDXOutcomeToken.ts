...
export interface PDXOutcomeTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface PDXOutcomeToken extends BaseContract {
  connect(runner?: ContractRunner | null): PDXOutcomeToken;
  waitForDeployment(): Promise<this>;

  interface: PDXOutcomeTokenInterface;
