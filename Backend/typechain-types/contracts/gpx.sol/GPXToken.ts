...
export interface GPXTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface GPXToken extends BaseContract {
  connect(runner?: ContractRunner | null): GPXToken;
  waitForDeployment(): Promise<this>;

  interface: GPXTokenInterface;
