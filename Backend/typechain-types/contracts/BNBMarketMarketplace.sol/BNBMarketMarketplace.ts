...
export declare namespace BNBMarketMarketplace {
...
export interface BNBMarketMarketplaceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "accumulatedFees"
      | "buyMarket"
...
export interface BNBMarketMarketplace extends BaseContract {
  connect(runner?: ContractRunner | null): BNBMarketMarketplace;
  waitForDeployment(): Promise<this>;

  interface: BNBMarketMarketplaceInterface;
  ...
  getListing: TypedContractMethod<
    [listingId: BigNumberish],
    [BNBMarketMarketplace.MarketListingStructOutput],
    "view"
  >;
