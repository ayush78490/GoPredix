// lib/web3/config.ts
export const PREDICTION_MARKET_ADDRESS = process.env.NEXT_PUBLIC_PREDICTION_MARKET_ADDRESS as string;
...
export const CUSTODIAL_MARKETPLACE_ADDRESS = "0x2FC004d8d92Dee66FDF042BcE63C88E255b1237a"; // BNB Marketplace
export const PDX_MARKETPLACE_ADDRESS = "0x6D005d00f8aCA64013B5F8fbf0161Ab80aA42173"; // PDX Marketplace (REDEPLOYED)
