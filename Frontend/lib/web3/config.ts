...
export const CUSTODIAL_MARKETPLACE_ADDRESS = process.env.NEXT_PUBLIC_BNB_CUSTODIAL_MARKETPLACE as string;
export const PDX_MARKETPLACE_ADDRESS = process.env.NEXT_PUBLIC_PDX_CUSTODIAL_MARKETPLACE as string;
