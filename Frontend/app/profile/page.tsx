    ...
    return (
      <main className="min-h-screen bg-background overflow-auto">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 text-center">
          ...
          <Button onClick={connectWallet} variant="outline" size="lg">Connect Wallet</Button>
        </div>
      </main>
    )
  }
            ...
            {contractAddress && (
              <div className="mt-8 pt-6 border-t border-gray-200">
                ...
                <div className="flex items-center justify-center gap-2">
                  ...
                  <Button variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => copyToClipboard(contractAddress)}>
                    <Copy className="w-3 h-3" />
                  </Button>
                  <Button variant="ghost" size="sm" className="h-6 w-6 p-0" onClick={() => window.open(getBlockExplorerUrl(contractAddress), '_blank')}>
                    <ExternalLink className="w-3 h-3" />
                  </Button>
                </div>
              </div>
              ...
              return (
                <Card key={index} className="p-6 hover:shadow-lg transition-shadow">
                  ...
                  <div className="flex gap-3">
                    ...
                    {status === MarketStatus.Resolved && (
                      <Button size="sm" className="bg-green-600 hover:bg-green-700">Redeem Winnings</Button>
                    )}
                    {status === MarketStatus.Open && (
                      <Link href={`/market/${position.market.id}?tab=trade`}>
                        <Button variant="outline" size="sm">Trade More</Button>
                      </Link>
                    )}
                  </div>
                </Card>
